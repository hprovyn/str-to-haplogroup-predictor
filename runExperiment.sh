...
python "$cladeFinder_py"  "$treeFile" "$samplestsv.bgz" "$cladeFinderOutputFile"
python "$createCSVinputForRF_py" "$treeFile" "$samplestsv.bgz" "$cladeFinderOutputFile" "$csvOutputForRFfile" "$panelHierarchyFile"
